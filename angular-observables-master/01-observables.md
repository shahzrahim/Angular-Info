# ![](https://ga-dash.s3.amazonaws.com/production/assets/logo-9f88ae6c9c3871690e33280fcf557f33.png) Observables
...
Inject the service into the component in `src/app/search/search.component.ts`, and remove the (now unneccessary) `Http` module:
...
Also, make sure you remove the import of `Http` at the top of `search.component.ts` since you only need it in the service now.
